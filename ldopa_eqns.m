...
ka_lung = p(11); %Lung absorption rate

k12 = k12 * V2/V1;
%% Equations
dydt = zeros(7,1);
dydt(1) = -ka * V1 *  y(1); %Drug in the gut
dydt(2) = ka * y(1) + ka_lung * y(6) - k_cl * y(2) - k12 * y(2) - k_met * y(2) + k21 * y(4) * V2 / V1; %l-dopa in the blood stream
...
dydt(6) = -ka_lung*y(6)* V1; %Drug in the lungs
dydt(7) = k_cl*y(2)*V1 + k_met*y(2)*V1 + k_met*y(4)*V2; %Mass balance
